...
// 🎸 Nothing Else Matters - Giriş Solosu (yaklaşık versiyon)
int melody[] = {
  NOTE_E4, NOTE_G4, NOTE_FS4, NOTE_E4, NOTE_D4, REST,
  NOTE_D4, NOTE_E4, NOTE_FS4, NOTE_G4, NOTE_A4, REST,
  NOTE_A4, NOTE_B4, NOTE_C5, NOTE_B4, NOTE_A4, NOTE_G4,
  NOTE_FS4, NOTE_E4, NOTE_D4, NOTE_E4, NOTE_G4, NOTE_FS4,
  NOTE_E4, NOTE_D4, NOTE_B3, REST
};
